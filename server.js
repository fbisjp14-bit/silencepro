...
async function processVideo(req, res) {
  ...
  try {
    ...
    const rendered = await renderWithCuts(inputPath, outputPath, cuts, info.duration);
...
app.listen(PORT, () => console.log('Silence Pro MP4 Smart HQ Final rodando na porta ' + PORT));
