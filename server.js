...
function getRenderSettings(mode) {
  ...
  if (value === 'fast') {
    return {
      ...
      label: 'Rápido',
      preset: 'ultrafast',
      crf: process.env.FFMPEG_FAST_CRF || '26',
      audioBitrate: '160k',
      fps: '30',
      scale: "scale=w=if(gt(iw\\,ih)\\,1280\\,-2):h=if(gt(iw\\,ih)\\,-2\\,1280)"
    };
  }
  ...
  return {
    ...
    label: 'Turbo',
    preset: 'ultrafast',
    crf: process.env.FFMPEG_TURBO_CRF || '30',
    audioBitrate: '128k',
    fps: '30',
